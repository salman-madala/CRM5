...
import classes from "./FolderDirective.module.css";
...
import FilesFolderMenuBar from "./ToolBar/FilesFolderMenuBar";
...
const FolderDirective = (props) => {
  // const [ items ,setItems]=useState([])
  const moreIcon = { iconName: "More" };

  const [isEditFolderModelOpen, setIsEditFolderModelOpen] = useState(false);
  ...
  const openEdit = (item) => {
    setIsEditFolderModelOpen(true);
    setEditFolder(item);
  };

  const onDismissHandler = () => {
    setIsEditFolderModelOpen((prev) => !prev);
  };
...
export default React.memo(FolderDirective);
